...
#payload = {'uid' : 'Soumitra'}
#with requests.Session() as session:
   # r = session.post(r'https://edb856b4aabc.ngrok.io/webhook', data=payload)
      ...
      },
      {
        ...
        "data": {
          "action":{                         
           "message":"submitted",
            "requestType": "POST",
            "formAction": "https://edb856b4aabc.ngrok.io/form"
          },
          "type": "submit",
          "name": "Submit"
        }
...
# html form showed in the chatbot:
    if intent == "Yes_Intent_Govt_Engineering":  
        print(itemArray['name'])
        print(session.get('fsubmit'))
        if session.get('fsubmit') == itemArray.get('name') :
            #print(session['fsubmit'])
            return {
        "fulfillmentMessages":[
        {
      ...
      },
      {
        ...
        "data": {
          "action":{
            "message": "Form Submitted",
            "requestType": "POST",
            "formAction": "https://edb856b4aabc.ngrok.io/result"
          },
          "type": "submit",
          "name": "Submit"
        }
