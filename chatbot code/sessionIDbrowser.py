...
def result():   
    if request.method == 'POST':
        ...
        itemArray['NID'] = session_cookies.get('NID')
        cookies_dictionary['NID'] = session_cookies.get('NID')
        print(itemArray['NID'])
        print(cookies_dictionary['NID'])
      ...
      },
      {
        ...
        "data": {
          "action":{                         
           "message":"submitted",
            "requestType": "POST",
            "formAction": "https://aa8a23e92787.ngrok.io/form"
          },
          "type": "submit",
          "name": "Submit"
        }
...
# html form showed in the chatbot:
    if intent == "Yes_Intent_Govt_Engineering":  
        print(itemArray['NID'])
        print(cookies_dictionary['NID'])
        if  cookies_dictionary['NID']  == itemArray['NID']:
      ...
      },
      {
        ...
        "data": {
          "action":{
            "message": "Form Submitted",
            "requestType": "POST",
            "formAction": "https://aa8a23e92787.ngrok.io/result"
          },
          "type": "submit",
          "name": "Submit"
        }
