from flask import Flask, render_template, request, jsonify, make_response,redirect, url_for,session, current_app
      ...
      },
      {
        ...
        "data": {
          "action":{                         
           "message":"submitted",
            "requestType": "POST",
            "formAction": "https://9039d0386092.ngrok.io/form"
          },
          "type": "submit",
          "name": "Submit"
        }
...
# html form showed in the chatbot:
    if intent == "Yes_Intent_Govt_Engineering": 
        with app.test_request_context('/https://2869a9fcd5c6.ngrok.io/test'):
      ...
      },
      {
        ...
        "data": {
          "action":{
            "message": "Form Submitted",
            "requestType": "POST",
            "formAction": "https://9039d0386092.ngrok.io/result"
          },
          "type": "submit",
          "name": "Submit"
        }
