...
def processRequest(req):
    ...
    if intent == "cityofcolleges":
        ...
        cur = mydb.cursor()
        if city == "Bengaluru":
            sql = 'SELECT College_Name,NIRF_rank,NIRF_score,NAAC_Grade  FROM stud_details1 WHERE city ="Bengaluru"'     
            cur.execute(sql)
            ...
            sql = 'SELECT College_Name,NIRF_rank,NIRF_score,NAAC_Grade FROM stud_details1 WHERE city ="Gharuan"'
            cur.execute(sql)
            myresult = cur.fetchall()
            for webhook in myresult:
                college.append(webhook)
            ...
            sql = 'SELECT College_Name,NIRF_rank,NIRF_score,NAAC_Grade FROM stud_details1 WHERE city ="Belgaum"'
            cur.execute(sql)
            myresult = cur.fetchall()
            for webhook in myresult:
                college.append(webhook)
            ...
            sql = 'SELECT College_Name,NIRF_rank,NIRF_score,NAAC_Grade FROM stud_details1 WHERE city ="chennai"'
            cur.execute(sql)
            myresult = cur.fetchall()
            for webhook in myresult:
                college.append(webhook)
            ...
            sql = 'SELECT College_Name,NIRF_rank,NIRF_score,NAAC_Grade FROM stud_details1 WHERE city ="Phagwara"'
            cur.execute(sql)
            myresult = cur.fetchall()
            for webhook in myresult:
                college.append(webhook)
