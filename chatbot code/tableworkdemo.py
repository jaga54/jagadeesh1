from flask import Flask, render_template, request, jsonify, make_response,redirect, url_for,session,app
      ...
      },
      {
        ...
        "data": {
          "action":{                         
           "message":"submitted",
            "requestType": "POST",
            "formAction": "https://d747dddccf29.ngrok.io/form"
          },
          "type": "submit",
          "name": "Submit"
        }
...
# html form showed in the chatbot:
    if intent == "Yes_Intent_Govt_Engineering": 
        if 'sequence' in session:
            session['sequence'] = session.get('sequence') # reading and updating session data
        ...
        "fulfillmentMessages":[
        {
            ...
            session['sequence'] = 1
            session['sequence'].append(global session['sequence'])
            session.permanent = True
      ...
      },
      {
        ...
        "data": {
          "action":{
            "message": "Form submitted",
            "requestType": "POST",
            "formAction": "https://d747dddccf29.ngrok.io/result"
          },
          "type": "submit",
          "name": "Submit"
        }
