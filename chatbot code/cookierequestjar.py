...
with requests.Session() as s:
    ...
    requestsJar.set("user","",domain="httpbin.org",path="/cookies")
    requestsJar.set('array', '', domain='httpbin.org', path='/extra')
...
def result():   
    if request.method == 'POST':
        ...
        itemArray['name'] = name
        cookies_array['submit']= name 
        print(itemArray['name'])
        print(cookies_array['submit'])
        #res = s.cookies.set('user',name) 
        res = requestsJar.set("user",name,domain="httpbin.org",path="/cookies")
        res1 = requestsJar.set("array",name,domain="httpbin.org",path="/extra")
        print(res)
        print(res1)
        return 'ok'
      ...
      },
      {
        ...
        "data": {
          "action":{                         
           "message":"submitted",
            "requestType": "POST",
            "formAction": "https://02e7e1ba76c9.ngrok.io/form"
          },
          "type": "submit",
          "name": "Submit"
        }
...
# html form showed in the chatbot:
    if intent == "Yes_Intent_Govt_Engineering":  
        print(itemArray['name'])
        print(cookies_array['name'])
        print(requestsJar.get('user'))
        print(requestsJar.get('array'))
        if  requestsJar.get('user')  == itemArray.get('name') :
        ...
        elif  requestsJar.get('array')  == cookies_array.get('name') :
            #print(session['fsubmit'])
            return {
        "fulfillmentMessages":[
        {
      ...
      },
      {
        ...
        "data": {
          "action":{
            "message": "Form Submitted",
            "requestType": "POST",
            "formAction": "https://02e7e1ba76c9.ngrok.io/result"
          },
          "type": "submit",
          "name": "Submit"
        }
