...
def processRequest(req):
    ...
    #intent = "studentdetails"
    Data = InsertData(intent,stud_name,email,mobile,city,country)
    cityy = parameters.get("geo-city")
    data1 = FetchData(intent,cityy)
    
def InsertData(intent,stud_name,email,mobile,city,country):
    #parameters = result.get("parameters")
